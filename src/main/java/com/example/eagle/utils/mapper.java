...
public class mapper {
    public static void map(CreateAccountRequest createAccount, Reader reader){
        reader.setUserName(createAccount.getUserName());
        reader.setPassword(createAccount.getPassword());
    }
